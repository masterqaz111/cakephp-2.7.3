			...
			<?php echo $this->Form->create('Comment', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo __($this->Form->input('prisoner_id', array('class' => 'form-control'))); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo __($this->Form->input('name', array('class' => 'form-control'))); ?>
					</div><!-- .form-group -->
					
					<div class="form-group">
						<?php echo __($this->Form->input('text', array('class' => 'form-control'))); ?>
					</div><!-- .form-group -->

					<?php echo __($this->Form->submit('Submit', array('class' => 'btn btn-large btn-primary'))); ?>
